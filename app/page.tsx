    ...
    <AnimalSlider />
      ...
      <section className="py-12 bg-white">
        <div className="container">
          <h2 className="text-3xl font-bold mb-6 text-center">최근 구조된 동물들</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-muted-foreground">2025.02.24</span>
              </div>
              <h3 className="font-medium mb-2">동물보호법 안내</h3>
              <p className="text-sm text-muted-foreground">동물보호법에 관한 중요 안내사항입니다.</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-muted-foreground">PAWREST의 안정적 운영을 위해 시스템 점검을 실시합니다.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-orange-100 text-orange-600 text-xs px-2 py-1 rounded-full">중요</span>
                <span className="text-sm text-muted-foreground">2025.01.03</span>
              </div>
              <h3 className="font-medium mb-2">개인정보 취급 방법에 관한 공지</h3>
              <p className="text-sm text-muted-foreground">
                개인정보 처리 방법에 관한 공지, 제2조에 따라 홈페이지에 게시한 이용 동의 안내를 확인해 주세요.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 p-8 md:p-12">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800">동물들목록 살펴보기</h2>
                  </div>
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    새로운 가족을 찾고 있는 다양한 동물들을 만나보세요. 각 동물의 특성, 나이, 건강 상태 등 자세한 정보를
                    제공하고 있습니다. 당신의 사랑과 보살핌을 기다리는 특별한 친구를 발견할 수 있을 거예요.
                  </p>
                  <Link
                    href="/animals"
